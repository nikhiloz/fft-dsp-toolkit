...
![Real-Time Architecture](reference/diagrams/realtime_architecture.png)
...
![Optimization Roadmap](reference/diagrams/optimization_roadmap.png)
...
> **📊 Use Cases** — [View full-size diagram →](reference/diagrams/use_cases.png)
